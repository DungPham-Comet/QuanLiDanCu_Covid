...
public class AddXetNghiemController implements Initializable{

    @FXML
    private Button addButton;

    @FXML
    private Button chonNguoiXetNghiemButton;
    ...
    private NhanKhau nguoiXetNghiem = ChonNhanKhauController.getSelectedNhanKhau();
    ...
    void chonNguoiCachLy(ActionEvent event) throws IOException {
        ...
        controller.setPreviousPage(ADD_XETNGHIEM_VIEW);
    ...
    void addXetNghiemButton(ActionEvent event) throws IOException {
    	...
    	String nguoiXetNghiem = nguoiXetNghiemTextField.getText();
    	String hinhThuc = hinhThucTextField.getText();
    	String thoiGian = thoiGianTextField.getText();
    	String ketQua = ketQuaTextField.getText();
    	if(nguoiXetNghiem.trim().equals("") || hinhThuc.trim().equals("") || thoiGian.trim().equals("")|| ketQua.trim().equals("")) {
			createDialog(
    		...
    		try {
    			...
    			int result = XetNghiemServices.addXetNghiem(conn, this.nguoiXetNghiem.getIdNhanKhau(), hinhThuc, thoiGian, ketQua);
    			if(result == 1) {
					createDialog(
    ...
    @FXML
    void chonNguoiXetNghiem(ActionEvent event) throws IOException {
    	Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource(CHON_NHAN_KHAU_VIEW));
        Parent studentViewParent = loader.load();
    ...
    @Override
   	public void initialize(URL arg0, ResourceBundle arg1) {
       	nguoiXetNghiemTextField.setText(this.nguoiXetNghiem.getHoTen());
   	}
